...
class FinalFantasyXIVGame(Game):
    ...
    def optional_game_constraint_templates(self) -> List[GameObjectiveTemplate]:
        return [
            ...
            GameObjectiveTemplate(
                label="For any objectives which require a non-limited combat role, complete it instead as a JOB",
                data={
    ...
    def game_objective_templates(self) -> List[GameObjectiveTemplate]:
        ...
        if "FATEs" in self.content_types_allowed or len(self.content_types_allowed) == 0:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete COUNT FATEs in ZONE with gold credit as a ROLE",
                    data={
                        "COUNT": (self.fate_range, 1),
                        "ZONE": (self.zones, 1),
                        "ROLE": (self.combat_roles, 1),
                    },
                ...
                GameObjectiveTemplate(
                    label="Complete one FATE with gold credit in each zone as a ROLE: ZONE",
                    data={
                        "ZONE": (self.zones, 3),
                        "ROLE": (self.combat_roles, 1),
                    },
            ...
            if self.unreasonable_tasks_enabled:
                objective_list += [
                    GameObjectiveTemplate(
                        label="Complete World FATE 'NAME' with gold credit as a ROLE",
                        data={
        ...
        if "Guildhests" in self.content_types_allowed or len(self.content_types_allowed) == 0:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete the Guildhest 'GUILDHEST' as a ROLE",
                    data={
        ...
        if "Treasure Hunt" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Decipher a MAP and claim its treasure as a ROLE",
                    data={
                ...
                GameObjectiveTemplate(
                    label="Enter the Treasure Dungeon 'DUNGEON' and clear at least one chamber for its reward as a ROLE",
                    data={
            ...
            if self.unreasonable_tasks_enabled:
                objective_list += [
                    GameObjectiveTemplate(
                        label="Enter the Treasure Dungeon 'DUNGEON' and successfully clear all chambers as a ROLE",
                        data={
                            "DUNGEON": (self.treasure_hunt_dungeons, 1),
                            "ROLE": (self.combat_roles, 1),
                        },
        ...
        if "Dungeons" in self.content_types_allowed or len(self.content_types_allowed) == 0:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete the Dungeon 'DUTY' as a ROLE",
                    data={
        ...
        if "Trials" in self.content_types_allowed or len(self.content_types_allowed) == 0:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete the Trial 'DUTY' as a ROLE",
                    data={
                        "DUTY": (self.trials, 1),
                        "ROLE": (self.combat_roles, 1),
                    },
        ...
        if "Extreme Trials" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete the Extreme Trial 'DUTY' as a ROLE",
                    data={
        ...
        if "Normal Raids" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete the Normal Raid 'DUTY' as a ROLE",
                    data={
        ...
        if "Savage Raids" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete the Savage Raid 'DUTY' as a ROLE",
                    data={
        ...
        if "Alliance Raids" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete the Alliance Raid 'DUTY' as a ROLE",
                    data={
        ...
        if "Chaotic Alliance Raids" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete the Chaotic Alliance Raid 'DUTY' as a ROLE",
                    data={
        ...
        if "Deep Dungeons" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete NUM unique sets of floors in DEEPDUNGEON as a ROLE (Prior saves allowed)",
                    data={
                ...
                GameObjectiveTemplate(
                    label="Obtain NUM Accursed Hoard from a single set of floors in DEEPDUNGEON as a ROLE (Prior saves allowed)",
                    data={
                ...
                GameObjectiveTemplate(
                    label="Complete a single set of floors in DEEPDUNGEON without triggering any floor traps as a ROLE (Prior saves allowed)",
                    data={
                        "DEEPDUNGEON": (self.deep_dungeons, 1),
                        "ROLE": (self.combat_roles, 1),
                    },
                ...
                GameObjectiveTemplate(
                    label="Defeat NUM enemies in DEEPDUNGEON as a ROLE (Prior saves allowed)",
                    data={
                ...
                GameObjectiveTemplate(
                    label="Complete a single set of floors in DEEPDUNGEON within 30 minutes as a ROLE (Prior saves allowed)",
                    data={
                        "DEEPDUNGEON": (self.deep_dungeons, 1),
                        "ROLE": (self.combat_roles, 1),
                    },
        ...
        if "Variant Dungeons" in self.content_types_allowed and len(self.variant_dungeon_routes()) > 0:
            objective_list += [
                GameObjectiveTemplate(
                    label="Complete the Variant Dungeon route which corresponds to the record entry 'ROUTE' as a ROLE",
                    data={
        ...
        if "Adventuring Forays" in self.content_types_allowed:
            if self.has_stormblood:
                objective_list += [
                    GameObjectiveTemplate(
                        label="Defeat the Notorious Monster spawn at Eureka LOC as a ROLE",
                        data={
                    ...
                    GameObjectiveTemplate(
                        label="Complete the Happy Bunny elemental conflict at Eureka FATE and uncover a QUALITY coffer",
                        data={
                ...
                if self.unreasonable_tasks_enabled:
                    objective_list += [
                        GameObjectiveTemplate(
                            label="Spawn and defeat the Notorious Monster for Eureka LOC as a ROLE",
                            data={
                                "LOC": (self.eureka_nm_fates, 1),
                                "ROLE": (self.combat_roles, 1),
                            },
            ...
            if self.has_shadowbringers:
                objective_list += [
                    GameObjectiveTemplate(
                        label="Complete the Skirmish at LOC as a ROLE",
                        data={
                    ...
                    GameObjectiveTemplate(
                        label="Complete the Critical Engagement at LOC as a ROLE",
                        data={
                ...
                if self.unreasonable_tasks_enabled:
                    objective_list += [
                        GameObjectiveTemplate(
                            label="Win the Critical Engagement duel at LOC as a ROLE",
                            data={
        ...
        if "Crystalline Conflict" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Participate in COUNT Crystalline Conflict matches as a ROLE",
                    data={
                ...
                GameObjectiveTemplate(
                    label="Win COUNT Crystalline Conflict matches as a ROLE",
                    data={
                        "COUNT": (self.crystalline_conflict_match_counts, 1),
                        "ROLE": (self.combat_roles, 1),
                    },
                ...
                GameObjectiveTemplate(
                    label="Score COUNT kills in a Crystalline Conflict match as a ROLE",
                    data={
                ...
                GameObjectiveTemplate(
                    label="Score COUNT assists in a Crystalline Conflict match as a ROLE",
                    data={
        ...
        if "Frontline" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Participate in a Frontline match as a ROLE",
                    data={
                        "ROLE": (self.combat_roles, 1),
                    },
                    is_time_consuming=False,
                ...
                GameObjectiveTemplate(
                    label="Win a Frontline match as a ROLE",
                    data={
                        "ROLE": (self.combat_roles, 1),
                    },
                    is_time_consuming=True,
                ...
                GameObjectiveTemplate(
                    label="Score COUNT kills in a Frontline match as a ROLE",
                    data={
                        "COUNT": (self.pvp_kill_counts, 1),
                        "ROLE": (self.combat_roles, 1),
                    },
                ...
                GameObjectiveTemplate(
                    label="Score COUNT assists in a Frontline match as a ROLE",
                    data={
                        "COUNT": (self.pvp_assist_counts, 1),
                        "ROLE": (self.combat_roles, 1),
                    },
        ...
        if "Rival Wings" in self.content_types_allowed:
            objective_list += [
                GameObjectiveTemplate(
                    label="Participate in a Rival Wings match as a ROLE",
                    data={
                        "ROLE": (self.combat_roles, 1),
                    },
                    is_time_consuming=False,
                ...
                GameObjectiveTemplate(
                    label="Win a Rival Wings match as a ROLE",
                    data={
                        "ROLE": (self.combat_roles, 1),
                    },
                    is_time_consuming=True,
                ...
                GameObjectiveTemplate(
                    label="Score COUNT kills in a Rival Wings match as a ROLE",
                    data={
                        "COUNT": (self.pvp_kill_counts, 1),
                        "ROLE": (self.combat_roles, 1),
                    },
                ...
                GameObjectiveTemplate(
                    label="Score COUNT assists in a Rival Wings match as a ROLE",
                    data={
                        "COUNT": (self.pvp_assist_counts, 1),
                        "ROLE": (self.combat_roles, 1),
                    },
    ...
    def combat_roles(self) -> List[str]:
        roles = []
        ...
        if any(job in tanks for job in self.combat_jobs()):
            roles.append("Tank")

        if any(job in healers for job in self.combat_jobs()):
            roles.append("Healer")

        if any(job in melee_dps for job in self.combat_jobs()):
            roles.append("Melee DPS")

        if any(job in physical_ranged_dps for job in self.combat_jobs()):
            roles.append("Physical Ranged DPS")

        if any(job in magical_ranged_dps for job in self.combat_jobs()):
            roles.append("Magical Ranged DPS")
    ...
    def firmament_high_tier_fishing_collectables(self) -> List[str]:
        ...
        high_tier_weather_fisher_collectables = [
        ...
        if self.has_heavensward and self.has_level_80_or_higher:
            ...
            if self.include_time_consuming_objectives:
                firmament_high_tier_fishing_collectables.extend(high_tier_weather_fisher_collectables)
    ...
    def triple_triad_card_from_opponent_common(self) -> List[str]:
        ...
        dawntrail_three_star_cards = [
            ...
            "Ollier Triple Triad card from Malevolent Weasel",
        ]
...
class FinalFantasyXIVPlayableJobs(OptionSet):
    ...
    Combat objectives expect a minimum of one non-limited combat job to be enabled.
    """
